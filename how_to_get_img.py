...
parser.add_argument('-m', '--trained_model', default='./weights/Resnet50_Final1.pth',
...
if __name__ == '__main__':
    ...
    VIDEO_FILE_PATH = "data/INHA/01_Trim.mp4"
    OUTPUT_FILE = 'data/IFEZ/Processed4_8.mp4'
            ...
            if len(cur_list) > len(_list):
                ...
                for bb in cur_list:
                    ...
                    try:
                        ...
                        if not os.path.exists("./results/5/"):
                            os.makedirs("./results/5/")
                        name = "./results/5/" + str(len(bb)) + ".jpg"
            ...
            # elif len(cur_list) < len(_list) and _c < 20:
                ...
                for box in _list:
                    ...
                    try:
                        ...
                        if not os.path.exists("./results/4/"):
                            os.makedirs("./results/4/")
                        name = "./results/4/" + str(box.order) + ".jpg"
                        cv2.imwrite(name, img_raw)
