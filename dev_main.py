...
if __name__ == '__main__':
    ...
    folder_list = []
    file_list = []
    folder_list = os.listdir('./frame/AIHUB_CCTV')
    # print(folder_list)

    for i in range(len(folder_list)):
        files = os.listdir('./frame/AIHUB_CCTV/%s' % folder_list[i])
    ...
    # 수정, 기존에 가져온 파일경로에 맞는 영상 생성

    VIDEO_FILE_PATH = "./frame/AIHUB_CCTV/Wander/122-1_cam01_wander02_place01_day_spring.mp4"
    OUTPUT_FILE = './Final_Proc/21.mp4'
