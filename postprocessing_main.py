...
if __name__ == '__main__':
    ...
    VIDEO_FILE_PATH = "data/INHA/Trim20secV2.mp4"
    OUTPUT_FILE = 'data/INHA/Processed_v2_2.mp4'
        ...
        if args.save_image:
            for b in dets:
                ...
                try:
                    ...
                    b = list(map(int, b))
                    k_size = 30
                    x1, x2, y1, y2 = b[0], b[2], b[1], b[3]

                    # cur_list.append([x1, x2, y1, y2])
                    print('bbox의 좌표는: ', x1, x2, y1, y2)

                    roi = img_raw[x1:x2, y1:y2]
                    roi = cv2.blur(roi, (k_size, k_size))
                    img_raw[x1:x2, y1:y2] = roi
